...
if (isset($_GET['adopt-id'])) {
    ...
    if ($countps > 0) {
        ...
        if ($rowu['money'] >= $rowps['money'] && $rowu['gold'] >= $rowps['gold'] && $rowu['diamond'] >= $rowps['diamond'] && $rowu['level'] >= $rowps['min_level'] && $free_slots > 0 && $adopted == 'No') {
            
            if ($bonustype == 'power') {
                $pet_pay = mysqli_query($connect, "UPDATE `players` SET money=money-'$money', gold=gold-'$gold', diamond=diamond-'$diamond', respect=respect+'$respect', power=power+'$bonusvalue' WHERE id='$player_id'");
            }
            if ($bonustype == 'agility') {
                $pet_pay = mysqli_query($connect, "UPDATE `players` SET money=money-'$money', gold=gold-'$gold', diamond=diamond-'$diamond', respect=respect+'$respect', agility=agility+'$bonusvalue' WHERE id='$player_id'");
            }
            if ($bonustype == 'endurance') {
                $pet_pay = mysqli_query($connect, "UPDATE `players` SET money=money-'$money', gold=gold-'$gold', diamond=diamond-'$diamond', respect=respect+'$respect', endurance=endurance+'$bonusvalue' WHERE id='$player_id'");
            }
            if ($bonustype == 'intelligence') {
                $pet_pay = mysqli_query($connect, "UPDATE `players` SET money=money-'$money', gold=gold-'$gold', diamond=diamond-'$diamond', respect=respect+'$respect', intelligence=intelligence+'$bonusvalue' WHERE id='$player_id'");
            }
                    ...
                    <div class="modal-body">
                        <center>
                            ...
                            <div class="row">
								...
								<div class="col-md-4">
                                    <img src="images/icons/diamond.png" width="30%"><br />
...
if (isset($_GET['return-id'])) {
    ...
    if ($countspp > 0) {
		...
		$diamond_back   = $rowpfrc['diamond'] / 2;
...
<?php
    ...
    } else if ($rowu['money'] < $rowpp['money'] || $rowu['gold'] < $rowpp['gold'] || $rowu['diamond'] < $rowpp['diamond'] || $rowu['level'] < $rowpp['min_level'] || $rowpp['vip'] == 'Yes' && $rowu['role'] != 'VIP') {
