...
if (isset($_GET['buy-id'])) {
    ...
    if ($countvs > 0) {
        ...
        if ($rowu['money'] >= $rowvs['money'] && $rowu['gold'] >= $rowvs['gold'] && $rowu['diamond'] >= $rowvs['diamond'] && $rowu['level'] >= $rowvs['min_level'] && $free_slots > 0 && $owned == 'No') {
            
            $vehicle_pay = mysqli_query($connect, "UPDATE `players` SET money=money-'$money', gold=gold-'$gold', diamond=diamond-'$diamond', respect=respect+'$respect' WHERE id='$player_id'");
...
<?php
            ...
            } else if ($rowu['money'] < $rowv['money'] || $rowu['gold'] < $rowv['gold'] || $rowu['diamond'] < $rowv['diamond'] || $rowu['level'] < $rowv['min_level'] || $rowv['vip'] == 'Yes' && $rowu['role'] != 'VIP') {
