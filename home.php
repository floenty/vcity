...
if (isset($_GET['sell-id'])) {
    ...
    if ($countsvv > 0) {
		...
		$diamond_back  = $rowvfsc['diamond'] / 2;
        
        $sell_vehicle = mysqli_query($connect, "DELETE FROM `player_vehicles` WHERE vehicle_id='$vehiclefs_id' AND player_id='$player_id'");
        
        $values_back = mysqli_query($connect, "UPDATE `players` SET money=money+'$money_back', gold=gold+'$gold_back', diamond=diamond+'$diamond_back' WHERE id='$player_id'");
                        ...
                        <center>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <h4>Diamond: <br /><hr /><span class="label label-default">+ ' . $diamond_back . '</span></h4>
                                </div>
                            </div><br /><br />
...
echo $rowu['gold'];
?></span></h5>
									<h5><strong><i class="fas fa-gem"></i> <?php
echo lang_key("diamond");
?>: </strong><span class="label label-info"><?php
echo $rowu['diamond'];
?></span></h5>
...
?></h3>
                        ...
                        <div class="panel-body">
<?php
$tday   = date_default_timezone_set("Asia/Jakarta");
$tmonth = date_default_timezone_set("Asia/Jakarta");
$tyear  = date_default_timezone_set("Asia/Jakarta");

$thour   = date_default_timezone_set("Asia/Jakarta");
$tminute = date_default_timezone_set("Asia/Jakarta");
