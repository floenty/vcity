...
if (isset($_POST['add'])) {
    ...
    $query = mysqli_query($connect, "INSERT INTO `homes` (image, money, gold, diamond, respect, min_level, vip, max_pets) VALUES ('$image', '$money', '$gold', '$diamond', '$respect', '$minlevel', '$vip', '$max')");
}
?>
...
if (isset($_GET['edit-id'])) {
    ...
    if (isset($_POST['edit'])) {
        ...
        $query = mysqli_query($connect, "UPDATE `homes` SET `image`='$image', `money`='$money', `gold`='$gold', `diamond`='$diamond', `respect`='$respect', `min_level`='$minlevel', `vip`='$vip', `max_pets`='$max' WHERE id='$id'");
        echo '<meta http-equiv="refresh" content="0; url=homes.php">';
