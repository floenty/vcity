...
if (isset($_POST['add'])) {
    ...
    $query = mysqli_query($connect, "INSERT INTO `vehicles` (image, category_id, speed, stability, acceleration, money, gold, diamond, min_level, respect, vip, active) VALUES ('$image', '$category_id', '$speed', '$stability', '$acceleration', '$money', '$gold', '$diamond', '$minlevel', '$respect', '$vip', '$active')");
}
?>
...
if (isset($_GET['edit-id'])) {
    ...
    if (isset($_POST['edit'])) {
        ...
        $query = mysqli_query($connect, "UPDATE `vehicles` SET `image`='$image', `category_id`='$category_id', `speed`='$speed', `stability`='$stability', `acceleration`='$acceleration', `money`='$money', `gold`='$gold', `diamond`='$diamond', `min_level`='$minlevel', `respect`='$respect', `vip`='$vip', `active`='$active' WHERE id='$id'");
        echo '<meta http-equiv="refresh" content="0; url=vehicles.php">';
