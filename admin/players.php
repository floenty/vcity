...
?>" required>
											...
											<div class="form-group">
												<label class="col-sm-2 control-label">Diamond: </label>
												<div class="col-sm-10">
...
<?php
    if (isset($_POST['edit'])) {
        ...
        $query = mysqli_query($connect, "UPDATE `players` SET avatar='$avatar', role='$role', money='$money', gold='$gold', diamond='$diamond', respect='$respect' WHERE id='$id'");
...
<table id="dt-basic" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									<thead>
										<tr>
											...
											<th><i class="fas fa-inbox"></i> Diamond</th>
