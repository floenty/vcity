...
if (isset($_POST['add'])) {
    ...
    $query = mysqli_query($connect, "INSERT INTO `jobs` (job_type, energy_cost, health_loss, money, gold, diamond, format, time) VALUES ('$jobtype', '$energy', '$health', '$money', '$gold', '$diamond', '$format', '$time')");
}
?>
...
if (isset($_GET['edit-id'])) {
    ...
    if (isset($_POST['edit'])) {
        ...
        $query = mysqli_query($connect, "UPDATE `jobs` SET `job_type`='$jobtype', `energy_cost`='$energy', `health_loss`='$health', `money`='$money', `gold`='$gold', `diamond`='$diamond', `format`='$format', `time`='$time' WHERE id='$id'");
        echo '<meta http-equiv="refresh" content="0; url=jobs.php">';
...
?>" required>
								...
								<div class="form-group">
											<label class="col-sm-3 control-label">Diamond Salary: </label>
											<div class="col-sm-9">
...
<form class="form-horizontal" action="" method="post">
				     <div class="box">
				        ...
				        <div class="box-body">
								...
								<div class="form-group">
											<label class="col-sm-4 control-label">Diamond Salary: </label>
											<div class="col-sm-8">
