...
if (isset($_GET['delete-id'])) {
    ...
    $query = mysqli_query($connect, "DELETE FROM `quays` WHERE id='$id'");
}
?>
<div class="content-wrapper">
			...
			<div id="content-container">
				...
				<section class="content-header">
    			  <h1><i class="fas fa-ship"></i> Quays</h1>
    			  <ol class="breadcrumb">
   			         <li><a href="dashboard.php"><i class="fas fa-Quay"></i> Admin Panel</a></li>
    			     <li class="active">Quays</li>
    			  </ol>
    			</section>
...
if (isset($_POST['add'])) {
    ...
    $query = mysqli_query($connect, "INSERT INTO `quays` (image, money, gold, diamond, respect, min_level, vip, max_vehicles) VALUES ('$image', '$money', '$gold', '$diamond', '$respect', '$minlevel', '$vip', '$max')");
}
?>
...
if (isset($_GET['edit-id'])) {
    $id  = (int) $_GET["edit-id"];
    $sql = mysqli_query($connect, "SELECT * FROM `quays` WHERE id = '$id'");
    $row = mysqli_fetch_assoc($sql);
    if (empty($id)) {
        echo '<meta http-equiv="refresh" content="0; url=quays.php">';
    }
    ...
    if (isset($_POST['edit'])) {
        ...
        $query = mysqli_query($connect, "UPDATE `quays` SET `image`='$image', `money`='$money', `gold`='$gold', `diamond`='$diamond', `respect`='$respect', `min_level`='$minlevel', `vip`='$vip', `max_vehicles`='$max' WHERE id='$id'");
        echo '<meta http-equiv="refresh" content="0; url=quays.php">';
...
<form class="form-horizontal" action="" method="post">
                     <div class="box">
						<div class="box-header">
							<h3 class="box-title">Edit Quay</h3>
						</div>
				        <div class="box-body">
...
<table id="dt-basic" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<tbody>
<?php
$query = mysqli_query($connect, "SELECT * FROM `quays`");
...
<form class="form-horizontal" action="" method="post">
				     <div class="box">
						<div class="box-header">
							<h3 class="box-title">Add Quay</h3>
						</div>
				        <div class="box-body">
								<div class="form-group">
											<label class="col-sm-4 control-label">Image: </label>
											<div class="col-sm-8">
												<input type="text" name="image" class="form-control" placeholder="images/backgrounds/quays/" required>
											</div>
								</div>
								<div class="form-group">
